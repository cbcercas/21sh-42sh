...
SRC_SUBDIR		= core
SRCS			+= sh_get_line.c main.c prompt.c init.c input.c usage_help.c input_utils.c \
...
SRCS            += tcaps_exec_arrow.c tcaps_exec_backspace.c \
                    ...
                    tcaps_key_exec.c tcaps_exec_delete.c tcaps_redraw_line.c\
										...
										tcaps_exec_select.c clean_term.c get_curs_y.c get_curs_x.c tcaps_exec_alt_v.c tcaps_exec_alt_c.c
